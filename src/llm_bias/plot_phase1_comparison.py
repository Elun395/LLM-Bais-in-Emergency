...
if __name__ == "__main__":
    # 文件路径
    deepseek_file = "/Users/lun/Downloads/work/研究生课程/危机决策与沟通/Data-for-Emergency 阶段一中文未改/outputs/phase1_deepseek.json"
    qianwen_file = "/Users/lun/Downloads/work/研究生课程/危机决策与沟通/Data-for-Emergency 阶段一中文未改/outputs/phase1_千问.json"
    output_file = "/Users/lun/Downloads/work/研究生课程/危机决策与沟通/Data-for-Emergency 阶段一中文未改/outputs/phase1_model_comparison.png"
    ...
    # 生成对比图
    try:
        fig, ax = plot_phase1_comparison(deepseek_file, qianwen_file, output_file)
        plt.show()
        print("对比图生成完成！")
