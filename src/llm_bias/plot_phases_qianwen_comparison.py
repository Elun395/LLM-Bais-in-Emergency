...
if __name__ == "__main__":
    # 文件路径
    phase2_file = "/Users/lun/Downloads/work/研究生课程/危机决策与沟通/Data-for-Emergency 阶段一中文未改/outputs/phase2_千问.json"
    phase3_file = "/Users/lun/Downloads/work/研究生课程/危机决策与沟通/Data-for-Emergency 阶段一中文未改/outputs/phase3_千问.json"
    phase4_file = "/Users/lun/Downloads/work/研究生课程/危机决策与沟通/Data-for-Emergency 阶段一中文未改/outputs/phase4_千问.json"
    output_file = "/Users/lun/Downloads/work/研究生课程/危机决策与沟通/Data-for-Emergency 阶段一中文未改/outputs/phases_qianwen_comparison.png"
    
    # 生成对比图
    try:
        fig, axes = plot_phases_qianwen_comparison(phase2_file, phase3_file, phase4_file, output_file)
        print("千问多阶段对比图生成完成！")
