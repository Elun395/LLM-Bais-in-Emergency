...
# -*- coding: utf-8 -*-
"""
从 phase2 responses JSON 文件中提取理由文本并生成词云图
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description='从 phase2 responses JSON 文件中提取理由文本并生成词云图')
    parser.add_argument('--deepseek-path', type=str, default='outputs/responses/phase2_responses_deepseek.json',
                       help='DeepSeek responses JSON 文件路径')
    parser.add_argument('--qwen-path', type=str, default='outputs/responses/phase2_responses_qwen.json',
                       help='Qwen responses JSON 文件路径')
    ...
    # 处理 DeepSeek 数据
    deepseek_texts = load_and_extract(args.deepseek_path)
    ...
    # 创建 DeepSeek 词云
    deepseek_output_path = os.path.join(args.output_dir, 'wordcloud_deepseek_phase2.png')
    create_wordcloud(
        deepseek_texts, 
    ...
    # 处理千问数据
    qwen_texts = load_and_extract(args.qwen_path)
    ...
    # 创建千问词云
    qwen_output_path = os.path.join(args.output_dir, 'wordcloud_qwen_phase2.png')
    create_wordcloud(
        qwen_texts,
        qwen_output_path,
