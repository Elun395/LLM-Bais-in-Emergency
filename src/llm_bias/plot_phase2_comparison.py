...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='绘制 DeepSeek 和千问的阶段二结果对比图')
    ...
    parser.add_argument('--output-file', type=str, 
                       default='outputs/phase2_model_comparison.png',
                       help='输出图片路径')
    args = parser.parse_args()
    
    # 生成对比图
    try:
        fig, axes = plot_phase2_comparison(args.deepseek_file, args.qianwen_file, args.output_file)
        print("Phase2 对比图生成完成！")
