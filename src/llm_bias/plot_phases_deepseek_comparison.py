...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='绘制 DeepSeek 多阶段对比图')
    parser.add_argument('--phase2-file', type=str, 
                       default='outputs/phase2_deepseek.json',
                       help='Phase 2 结果文件路径')
    parser.add_argument('--phase3-file', type=str, 
                       default='outputs/phase3_deepseek.json',
                       help='Phase 3 结果文件路径')
    parser.add_argument('--phase4-file', type=str, 
                       default='outputs/phase4_deepseek.json',
                       help='Phase 4 结果文件路径')
    parser.add_argument('--output-file', type=str, 
                       default='outputs/phases_deepseek_comparison.png',
                       help='输出图片路径')
    args = parser.parse_args()
    
    # 生成对比图
    try:
        fig, axes = plot_phases_deepseek_comparison(args.phase2_file, args.phase3_file, args.phase4_file, args.output_file)
        print("DeepSeek 多阶段对比图生成完成！")
